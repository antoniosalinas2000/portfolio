...
export default function Header(props: {currentPage:string }) {
    ...
    return (
        <div className="flex flex-row w-full items-center justify-between px-2 lg:px-16 py-3 lg:py-6">
            <h1 className="text-xl lg:text-4xl font-iceland">Antonio Salinas</h1>
